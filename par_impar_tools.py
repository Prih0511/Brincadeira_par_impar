...
# Quando você vai definir funções e executar coisas no seu script, sempre defina as funções antes e execute depois:

#usuario escolher entre par ou impar e restornar oque ele escolheu na tela.
def par_ou_impar (): 
    # Apenas deixe como parâmetros de entrada algo que você quer que mude
    # Como txt é a mensagem a ser enviada ao usuário, ela é a mesma sempre, então deixamos ela dentro da função
    txt="Escolha entre PAR ou IMPAR:" 
    perguntar_par_impar = ""
...
def validacao():
    ...
    txt="Escolha um numero para nossa brincadeira:" # Mesma coisa da função anterior
    while True:
...
if __name__ == "__main__":
    # Veja que quando você define tudo lá em cima, o código que você quer executar fica bem mais limpo
